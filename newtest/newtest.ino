...
/**************************************************************************/
/*!
    @brief  Changes hardware orientation of display
*/
/**************************************************************************/
void orientation(void) {
  ...
  delay(1000);
  display.setOrientation(SSD1331_ROTATE_180FLIP);
  delay(1000);
...
/**************************************************************************/
/*!
    @brief  Changes hardware mode of display
*/
/**************************************************************************/
void mode(void) {
  ...
  delay(1500);
  display.setDisplayMode(SSD1331_CMD_DISPLAYALLON);
  delay(1500);
  display.setDisplayMode(SSD1331_CMD_DISPLAYALLOFF);
  delay(1500);
...
/**************************************************************************/
/*!
    @brief  Changes grey scale of display
*/
/**************************************************************************/
void fade(void) {

  display.setGrayScale(0.1);
  delay(500);
  display.setGrayScale(2);
  delay(500);
...
/**************************************************************************/
/*!
    @brief  Clears section of display
*/
/**************************************************************************/
void clearbox(void) {

  display.clearWindow(2, 2, 42, 30);
  delay(500);
  display.clearWindow(2, 32, 42, 62);
  delay(500);
  display.clearWindow(45, 2, 92, 30);
  delay(500);
  display.clearWindow(45, 32, 92, 62);

}

/**************************************************************************/
/*!
    @brief  Sets up hardware scrolling
*/
/**************************************************************************/
void scrolling(void) {

  display.setScroll(4, 0, 0, 64, 0);
  display.startScroll();
  delay(5000);
  display.stopScroll();
  display.setScroll(0, 4, 0, 64, 0);
  display.startScroll();
  delay(5000);
  display.stopScroll();
